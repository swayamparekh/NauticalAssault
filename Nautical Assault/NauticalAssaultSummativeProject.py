...
shootSFX= pygame.mixer.Sound("shootSFX.wav")
collisionSFX = pygame.mixer.Sound("collision.wav")
gstartSFX = pygame.mixer.Sound("gstartSFX.wav")
gameOverSFX1 = pygame.mixer.Sound("gameOver1.wav")
gameOverSFX2= pygame.mixer.Sound("gameOver2.wav")
buttonSFX= pygame.mixer.Sound("buttonSFX.wav")
